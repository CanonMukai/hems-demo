...
お天気が悪いほど時間がかかるかもしれません...☂️のときなんか最悪ですね...

「少し使いすぎな2人世帯」「5人世帯」の場合もちょっとお時間いただくかもしれません...

初期蓄電量が少ない場合もちょっとかかるかも...

速いと10秒弱で終わるのですが、遅いと数分かかるかも...？

このページは dwave-neal という、シミュレーテッド・アニーリングの Python パッケージをありがたく使わせていただいています。
...
私(開発者)はうっかり「☂️」「5人」「0 (W)」を選択してしまったことがあって、そのときは10回やそこらじゃ足りませんでした...
...
非常にご迷惑をおかけしております...ここまでお待ちくださり、本当にありがとうございます...今日はきっと何か良いことがあります😊
'''.format(emoji)
    ...
    if hq:
        if successful:
            if st.session_state.long_time:
                st.success('大変長らくお待たせいたしました m(_ _)m')
            create_result(hq)
        else:
            st.error('''
